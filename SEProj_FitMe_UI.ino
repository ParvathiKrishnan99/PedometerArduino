            ...
            for (uint8_t b = 0; b < 15; b++) {
                ...
                if (buttons[b].justPressed()) {
                    ...
                    if (b == 0) {
                        ...
                        inputWeight = (weight[0] * 100) + (weight[1] * 10) + weight[2];
            ...
            for (uint8_t b = 0; b < 15; b++) {
                ...
                if (buttons[b].justPressed()) {
                    ...
                    if (b == 0) {
                        ...
                        //Error - report incorrect age
                        //} else {
                        inputHeight = (height[0] * 100) + (height[1] * 10) + height[2];
...
void startWalking(void)
{
    if (screen == 4) {
        ...
        if (once) {
            ...
            tft.println("How many steps have you taken?");
            delay(3000);
            tft.fillScreen(BLACK);
            memset(textfield, 0, TEXT_LEN);
            textfield_i = 0;
...
//screen 5 ; calorie count and display results
void calorieCount(void) {
    if (screen == 5) {
        ...
        if (once) {
            ...
            //      tft.println(avgStrLen);
            
            
            timeDiff = TIME_DIFF;
            
            
            avgSpeed = avgStrLen / timeDiff;
            // tft.println("TIME");
            // tft.println(timeDiff);
            // tft.println("AVGSPEED");
            ...
            if (avgSpeed > 0.12) {
                ...
                calories = inputWeight * 0.72;
                calPerStep = calories / inputSteps;
                CalBurntMile = calPerStep * inputSteps;
                
            } else if (avgSpeed < 0.02) {
